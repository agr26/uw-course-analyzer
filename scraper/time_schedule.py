...
class TimeScheduleScraper:
    ...
    def parse_course_info(self, html_content, filename):
        ...
        bg_colors = [
            '#ffcccc', '#99ccff', '#FFCCCC', '#99CCFF',
            'ffcccc', '99ccff', 'FFCCCC', '99CCFF',
            '#cce5ff', '#CCE5FF', 'cce5ff', 'CCE5FF',  # Light blue
            '#ffccd9', '#FFCCD9', 'ffccd9', 'FFCCD9'   # Light pink
        ]
        ...
        for html_file in sorted(html_files):
            ...
            try:
                ...
                course_tables = soup.find_all('table', attrs={'bgcolor': [
                    '#ffcccc', '#99ccff', '#FFCCCC', '#99CCFF',
                    'ffcccc', '99ccff', 'FFCCCC', '99CCFF',
                    '#cce5ff', '#CCE5FF', 'cce5ff', 'CCE5FF',
                    '#ffccd9', '#FFCCD9', 'ffccd9', 'FFCCD9'
                ]})
